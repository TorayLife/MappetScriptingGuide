...
### Закрытие функциональных выражений
...
### Хэш-комментарии в стиле сценариев оболочки
...
### Nashorn расширяет объекты ошибок Error
